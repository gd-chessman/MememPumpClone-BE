...
async function bootstrap() {
  ...
  const corsConfig = {
    origin: process.env.NODE_ENV === 'production'
      ? ['https://meme-pump-frontend-clone.vercel.app', 'https://memepump-bg-affilate.vercel.app', 'https://memepump.vip', 'https://admin.memepump.vip', 'https://admin.memepump.gg', 'https://affiliate.memepump.vip', 'https://affiliate.memepump.gg', 'http://localhost:3600', 'http://localhost:3000']

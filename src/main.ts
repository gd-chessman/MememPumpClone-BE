...
async function bootstrap() {
  ...
  const corsConfig = {
    origin: process.env.NODE_ENV === 'production'
      ? ['https://memepump.gg', 'https://www.memepump.gg', 'https://memepump.vip', 'https://admin.memepump.vip', 'https://admin.memepump.gg', 'https://affiliate.memepump.vip', 'https://affiliate.memepump.gg', 'http://localhost:3600']
